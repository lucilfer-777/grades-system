...
(33, 2, 'Updated grade components for subject 2', '2026-03-13 02:40:38'),
(34, 2, 'Updated grade components for subject 2', '2026-03-13 02:44:01'),
(35, 2, 'Updated grade components for subject 2', '2026-03-13 02:44:17'),
(36, 2, 'Encoded grade for student 12 in subject 2 (3rd Year - 2nd Semester): 48.5% (5)', '2026-03-13 02:49:30');
...
(1, 12, 2, '3rd Year - 2nd Semester', 48.50, 5.00, 'Failed', 'Pending', 1);
...
(29, 2, 'Attendance', 10.00, 'percentage'),
(30, 2, 'Assessment', 25.00, 'raw'),
(31, 2, 'Project', 25.00, 'percentage'),
(32, 2, 'Exam', 40.00, 'raw');
...
(68, 30, 'Quiz #2', 2),
(69, 30, 'Quiz #3', 3),
(70, 30, 'Group Activity #1', 4),
(71, 30, 'Group Activity #2', 5),
(77, 31, 'Integrated System', 1),
(79, 32, 'Prelim', 1);
...
INSERT INTO `grade_components` (`grade_component_id`, `student_id`, `subject_id`, `academic_period`, `component_id`, `raw_score`, `max_score`, `category_id`, `item_id`) VALUES
(1, 12, 2, '3rd Year - 2nd Semester', 0, 0.00, 100.00, 29, 65),
(2, 12, 2, '3rd Year - 2nd Semester', 0, 8.00, 10.00, 30, 67),
(3, 12, 2, '3rd Year - 2nd Semester', 0, 8.00, 10.00, 30, 68),
(4, 12, 2, '3rd Year - 2nd Semester', 0, 10.00, 10.00, 30, 69),
(5, 12, 2, '3rd Year - 2nd Semester', 0, 15.00, 20.00, 30, 70),
(6, 12, 2, '3rd Year - 2nd Semester', 0, 15.00, 20.00, 30, 71),
(7, 12, 2, '3rd Year - 2nd Semester', 0, 0.00, 100.00, 31, 77),
(8, 12, 2, '3rd Year - 2nd Semester', 0, 35.00, 50.00, 32, 79);
...
--
ALTER TABLE `grade_components`
  MODIFY `grade_component_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
